...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next : $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("buttonNext").attr("onmouseover", "return ValidateSignup();"),
        // previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious"),
        finish  : $('<a>'+options.labelFinish+'</a>').attr("href","/registration/company").addClass("buttonFinish")
    };
    ...
    var _init = function($this) {
        ...
        $($this.buttons.finish).click(function() {
            ...
            window.open("http://itsparktech.com/onhand/select-services.php","_self")
                    if(frm && frm.length){
                        frm.submit();
                    }
                }

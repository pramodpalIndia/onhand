...
class CountryExample(models.Model):
    name = models.CharField(max_length=256)
...
class KitchenSink(models.Model):
    ...
    country = models.ForeignKey(CountryExample, related_name='foreign_key_country')
    linked_foreign_key = models.ForeignKey(CountryExample, limit_choices_to={
        'continent__name': 'Europe'}, related_name='foreign_key_linked')
    raw_id_field = models.ForeignKey(CountryExample,
...
#
class CityExample(models.Model):
    name = models.CharField(max_length=64)
    country = models.ForeignKey(CountryExample)
